...
import Web1Faq from './Web1Faq'
import Footer from './Footer'
// import FaqPage1 from './Web1Faq';
...
const Web1 = () => {
    ...
    const cardsData = [
        ...
        { title: "Content Management System (CMS)", description: "A Content Management System (CMS) is a software application that enables users to create, manage, and publish digital content on the web without requiring extensive technical knowledge. It streamlines content creation and modification processes, allowing for easy collaboration, version control, and website maintenance." },
    ...
    //   const logos = [
    //     { id: 1, src: "https://www.appslure.com/wp-content/uploads/2021/10/rehau-logo-300x95-1.png", alt: "Industry 1" },
    //     { id: 2, src: "", alt: "Industry 2" },
    //     { id: 3, src: "", alt: "Industry 3" },
    //     { id: 4, src: "", alt: "Industry 4" },
    //     { id: 5, src: "", alt: "Industry 5" },
    //     { id: 6, src: "", alt: "Industry 6" },
    //     { id: 7, src: "", alt: "Industry 7" },
    //     { id: 8, src: "", alt: "Industry 8" }
    //   ];
      ...
      <div className="bg-white bg-opacity-75 p-8 rounded-lg shadow-md w-full max-w-6xl flex flex-wrap">
        ...
        <div className="w-full md:w-1/2 p-4">
          ...
          <div className='mt-6'>
            ...
            <mailto:p>contact@company.com</p>
          </div>
        </div>
