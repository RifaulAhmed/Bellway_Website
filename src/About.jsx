  ...
  return (
    ...
    <CNavbar />
      <div>
          ...
          <div className="flex flex-col  md:flex-row items-center">
            <div className="lg:w-1/2 text-left mb-4 md:mb-0">
              ...
              <h3 className="text-2xl text-white">
                <a href="/faq-page" className="text-red-600 hover:underline">Home</a> / About Us
              </h3>
            </div>
            <div className="md:w-1/2 text-right">
              <img src="https://images.unsplash.com/photo-1557426272-fc759fdf7a8d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjAyfHxvZmZpY2V8ZW58MHx8MHx8fDA%3D" alt="Team" className="w-full h-auto" />
            </div>
          </div>
        </div>
        ...
        {/* <!-- New Blog Container --> */}
        <div className="containerx mx-auto  p-12 mybg btext">
          <h2 className="text-6xl font-bold mb-6 text-center hover:text-red-600">About Us</h2>
          <br /><br />

          {/* <!-- Blog Post 1 --> */}
          <div className="flex flex-col md:flex-row items-center mb-8  mt-8">
            <div className="md:w-1/2 mb-4 md:mb-0">
              <img src="https://plus.unsplash.com/premium_photo-1661768375570-eaed6b9a615c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTgxfHxvZmZpY2V8ZW58MHx8MHx8fDA%3D" alt="Tech Future" className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            <div className="md:w-1/2 md:pl-8">
              <h3 className="text-3xl font-bold  hover:text-red-600 text-center">Who We Are?</h3>
              <p className="text-xl mb-4 mt-8">Bellway Infotech is a top-rated website and mobile app (Android/iOS) marketing firm with over 500 projects completed.
                <br /><br />
          ...
          {/* <!-- Blog Post 2 --> */}
          <div className="flex flex-col md:flex-row-reverse items-center mb-8 mt-20">
            <div className="md:w-1/2 mb-4 md:mb-0">
              <img src="https://plus.unsplash.com/premium_photo-1682432977047-51f4d9465f2c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTkzfHxvZmZpY2V8ZW58MHx8MHx8fDA%3D" alt="React" className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            <div className="md:w-1/2 md:pr-8">
              <h3 className="text-3xl font-bold  hover:text-red-600 text-center">Who We Can Help</h3>
          ...
          <div className="flex flex-col md:flex-row items-center mb-8 mt-20">
            <div className="md:w-1/2 mb-4 md:mb-0">
              <img src="https://plus.unsplash.com/premium_photo-1683141420877-f191c7458781?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjA1fHxvZmZpY2V8ZW58MHx8MHx8fDA%3D" alt="Laravel" className="w-full h-auto rounded-lg shadow-lg" />
            </div>
            <div className="md:w-1/2 md:pl-8">
              <h3 className="text-3xl font-bold  hover:text-red-600 text-center">Our Process</h3>
              <p className="text-xl mb-4 mt-8">We have a team of dedicated employees who give their all in the fields in which they work.<br /><br /> Every employee is given a personal laptop with the most up-to-date features to handle first-className applications, as well as a cabin to ensure they can enjoy their personal space and work without distractions.<br /><br />  Despite working independently, this team is always on the same page. And it is to provide the best product to the clients regardless of external factors.</p>
        ...
        <div className="flex items-center justify-center mybg ">
          <div className="mybg p-6 rounded-lg shadow-md text-center maxW sm:mx-auto ">
            ...
            <div className="button-wrapper-1 mt-20">
              <a href="#"><button className="hover-button-bellway">Learn More</button></a>
            </div>
          </div>
        </div>
        ...
        <div className="min-h-screen flex flex-col md:flex-row mt-32">
          ...
          <div className="w-full md:w-1/2 bg-black text-white p-8 flex flex-col justify-center items-start">
        ...
        <div className="flex items-center justify-center mybg sm:mt-32">
          <div className="mybg p-6  sm:text-center sm:w-1/2 sm:mx-auto ">
            <h1 className="text-3xl text-center font-bold mb-4 text-black ">"Our Teams"</h1>
            <p className="sm:text-lg mb-4  mt-14 ">In a world where technology is the backbone of everything we do, our IT team stands as the cornerstone of our success. Day in and day out, they work tirelessly to keep our systems running smoothly, our data secure, and our digital dreams alive. </p>


            <h1 className="sm:text-xl font-bold mb-4 text-black text-center  mt-20">Mohit Shrivastava</h1>
