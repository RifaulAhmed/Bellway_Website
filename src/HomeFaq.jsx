...
const HomeFaq = () => {
    ...
    return (
        <div className="mx-auto py-8 bg-gray-100 h-full">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="accordion sm:mt-12 mx-4 sm:mx-0">
                    {FAQ_DATA.map((faq, index) => (
                        <div
                            key={index}
                            className="border border-gray-300 rounded-md overflow-hidden mb-4"
                        >
                            <div
                                className="accordion-title sm:text-xl font-semibold p-4 cursor-pointer bg-white hover:bg-gray-100 transition duration-300 flex justify-between items-center"
                            ...
                            <div
                                className={`accordion-content p-4 bg-white transition-all duration-300 ${
