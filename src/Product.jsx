            ...
            <div class="containerx mx-auto  bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="sm:text-8xl font-bold mb-4 text-white">Delicious Meals Delivery</h1>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src="https://bellwayinfotech.com/assets/uploads/media-uploader/delicious-meal-compressed1689941177.jpg"
                            alt="Bellway Grocery"
                        ...
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-1 md:mt-0 text-center md:text-left">
                            <h2 className="text-4xl font-bold">Delicious Meal Service</h2>
                            <p className="mt-9 text-lg" style={{textAlign:'start'}}> Tired after a long day? Craving your favourite cuisine? Don't worry, Delicious Meals Delivery App is here to satisfy your cravings and make mealtime a delightful experience. Discover the amazing ways you can use our app to enjoy scrumptious meals delivered right to your doorstep.
...
Open the app and explore a diverse range of restaurants and cuisines in your area. From Italian to Thai, burgers to sushi, our app offers an array of options to please every palate.
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center mt-20" >
                        <img
                            src="https://bellwayinfotech.com/assets/uploads/media-uploader/group-2945-compressed1689941177.jpg"
                            alt="Grocery"
                        ...
                        <div className="md:mr-28 mt-4 md:mt-0 text-center md:text-left mx-9">
                            <h2 style={{ textAlign: 'left' }} className="text-4xl font-bold">Why is Delicious Meals Delivery a useful resource for you?<br /></h2>
                            <p style={{ textAlign: 'left' }} className="mt-9 text-lg"> In today's fast-paced world, finding time to prepare a nutritious and mouthwatering meal can be a challenge. That's where Delicious Meal Delivery Service comes to the rescue! Our service is designed to provide you with a convenient and flavorful dining experience, offering a wide variety of delectable dishes delivered straight to your doorstep.

<br/>Have specific dietary requirements or preferences? Customize your order accordingly. Whether it's vegan, gluten-free, or extra spicy, we aim to cater to your unique needs.

Planning a family dinner or a meal with friends? The app makes it easy to place large orders, ensuring everyone gets their favourite dish.
