...
import team1 from './assets/team11-1.png'
import team2 from './assets/team11-2.png'
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src={team1}
                            alt="team-11"
                            className="w-1/2  md:w-1/2 h-1/2" style={{ boxShadow: '0 0 20px rgba(0, 0, 0, 0.6)' }}
                        />
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-1 md:mt-0 text-center md:text-left">
                            <h2 className="text-4xl font-bold">Team-11</h2>
                            <p className="mt-9 text-lg" style={{textAlign:'start'}}> Team 11 is a popular fantasy sports platform. Players can create virtual teams using real-life players from sports such as cricket, football, basketball, kabaddi, and others. Users can then earn points based on the performance of the selected players in actual matches.
                                <br />
                                Here's how Team 11 generally works:
                                <br />
                                Team Selection: Users can participate in contests by selecting a team of real players from upcoming matches. Each player is assigned a specific credit value, and users need to create a balanced team within a budget constraint.
                                <br />
                                Contest Participation: After selecting the team, users can join different types of contests with varying entry fees and prize amounts. Dream11 offers a range of contests to suit different budgets and preferences.
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center mt-20" >
                        ...
                        <div className="md:mr-28 mt-4 md:mt-0 text-center md:text-left mx-9">
                            <h2 style={{ textAlign: 'left' }} className="text-4xl font-bold">Why is Team-11 a useful resource for you?<br /></h2>
                            <p style={{ textAlign: 'left' }} className="mt-9 text-lg">For controlling the thrill and involvement in fantasy sports, a platform such as this one is indispensable. With Team 11, users may construct virtual teams made up of real-life athletes from a variety of sports, including basketball, kabaddi, football, and cricket. Customization is the core feature of our platform; it allows you to personalize your fantasy experience to your liking.<br /> Whether you require customized modules for player data, match schedules, or real-time scoring, our adaptable system may be tailored to meet your needs.<br /> You may tailor league settings and contests to your interests and provide each user a unique experience to increase user engagement. Our modular architecture allows you to choose the features you need today and add more as your fantasy sports experience develops.
                            </p>
                        </div>
                    </div>
                </div>
